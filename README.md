...
This web app: Rochester, New York Park Finder
...
The most challenging part of building this app was the CSS. I got help from Google and GitHub Copilot.
I used the Flag of the City of Rochester, New York, from [Wikipedia](https://en.wikipedia.org/wiki/Flag_of_Rochester,_New_York)
I got the color scheme from the website from [Coolors](https://coolors.co/386641-6a994e-a7c957-f2e8cf-bc4749)

## License

    Copyright 2026 Ryan O'Maley
